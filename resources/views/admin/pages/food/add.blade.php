            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px"> 
                    ...
                    <div class="pd-20 card-box mb-30">
                        <div class="clearfix">
                            <div class="pull-left">
                                <h4 class="text-blue h4">Food Form</h4> 
                            </div> 
                        </div>
                        
                        <form action="{{ route(name: 'admin.foods.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <input 
                                        ...
                                        type="text" 
                                        placeholder="Pork Tenderloin Marinated" 
                                        name="food_name" 
                                        value="{{ old('food_name') }}"
                                    />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10">
                                    <textarea class="form-control" name="description" placeholder="Ingredients and details...">{{ old('description') }}</textarea>
                                </div>
                            </div>
