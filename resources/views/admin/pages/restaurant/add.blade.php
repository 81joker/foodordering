                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="POST" action="{{ route('admin.restaurants.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="restaurant_name"
                                    placeholder="Domino's Pizza" value="{{ old('restaurant_name') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <select class="custom-select2 form-control" multiple name="cuisines_id[]"
                                    style="width:100%">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="address"
                                    placeholder="5th Avenue New York 68" value="{{ old('address') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="delivery_fee" placeholder="5.00"
                                    step="0.01" value="{{ old('delivery_fee') }}">
                                @error('delivery_fee')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
