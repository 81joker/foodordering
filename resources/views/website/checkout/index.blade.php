                                    ...
                                    <div class="col-md-3 col-sm-12 col-lg-3">
                                        <div class="reservation-tabs-list brd-rd5">
                                            <ul class="nav nav-tabs brd-rd5">
                                                <li class="active"><a href="#reservation-tab1" data-toggle="tab"><span
                                                            class="brd-rd50">2</span> Checkout</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="reservation-tab1">
                                                    <div class="order-wrapper2 brd-rd5">
                                                        <form id="update-all-form" action="{{ route('cart.update') }}"
                                                            method="POST">
                                                            @csrf
                                                            ...
                                                            <div class="reservation-header"
                                                                ...
                                                                <button type="submit" class="red-bg brd-rd5"
                                                                    style="color:#fff;border:0; padding:8px 16px; cursor:pointer;">
                                                                    Update
                                                                </button>
                                                            </div>
                                                            ...
                                                            <ul class="ordr-lst brd-rd5">
                                                                ...
                                                                @php
                                                                    $tax = $subtotal * 0.03;
                                                                @endphp
                                                                <li>Subtotal <span>${{ number_format($subtotal, 2) }}</span>
                                                                </li>
                                                                <li>Gov Tax <span>${{ number_format($tax, 2) }}</span></li>
                                                                <li class="red-bg">Total
                                                        ...
                                                        <form action="{{ route('checkout.place_order') }}" method="POST"
                                                            class="restaurant-info-form checkout-info-form brd-rd5">
                                                            @csrf
                                                            <div>
                                                                <div>
                                                            ...
                                                            <div class="pay-mnt">
                                                                <span class="radio-box">
                                                                    <input type="radio" name="pay_mthd" value="cash"
                                                                        id="mthd1">
                                                                    <label for="mthd1">Cash on delivery</label>
                                                                </span>
                                                                <span class="radio-box">
                                                                    <input type="radio" name="pay_mthd" value="online"
                                                                        id="mthd2">
                                                                    <label for="mthd2">Paypal <img
                                                                            src="assets/images/pay-mthd-img.jpg"
                                                                            alt="pay-mthd-img.jpg" itemprop="image"></label>
                                                                </span>
                                                            </div>
                                                            <div class="ordr-btn">
                                                                <button class="red-bg brd-rd3" type="submit">Place
                                                                    Order</button>
