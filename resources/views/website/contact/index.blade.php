                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-lg-4">
                                    <div class="contact-info-box">
                                        ...
                                        <p itemprop="description">5Tth Floor, AH Building, 756 New St Melbourne, Australia.
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-lg-4">
                        ...
                        <div class="contact-form-wrapper text-center">
                            <div class="contact-form-inner">
                                <h3 itemprop="headline">If You Got Any Questions <br> Please Do Not Hesitate to Send us a
                                    Message.</h3>
                                <div id="message"></div>
                                <form method="post" action="https://html.webinane.com/food-chow/contact.php"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12">
                                            ...
                                            <img src="assets/images/ajax-loader.gif" class="loader" alt="ajax-loader.gif"
                                                itemprop="image">
                                        </div>
                                    </div>
                                </form>
