...
@section('content')
            ...
            <div class="restaurant-searching text-center">
                <div class="restaurant-searching-inner">
                        ...
                        <div class="row mrg10">
                            <div class="col-md-6 col-sm-5 col-lg-5 col-xs-12">
                                <div class="input-field brd-rd2"><input class="brd-rd2" type="text"
                                        name="restaurant_name" placeholder="Restaurant Name"></div>
                            </div>
                    ...
                    <div class="funfacts">
                        ...
                        <div class="col-md-3 col-sm-6 col-lg-3">
                            <div class="fact-box">
                                <i class="brd-rd50"><img src="frontend/assets/images/resource/fact-icon2.png"
                        ...
                        <div class="col-md-3 col-sm-6 col-lg-3">
                            <div class="fact-box">
                                <i class="brd-rd50"><img src="frontend/assets/images/resource/fact-icon3.png"
                ...
                <img class="left-scooty-mockup" src="frontend/assets/images/resource/restaurant-mockup1.png"
                    alt="restaurant-mockup1.png" itemprop="image">
                <img class="bottom-clouds-mockup" src="frontend/assets/images/resource/clouds.png" alt="clouds.png"
                    itemprop="image">
                        ...
                        <div class="title1-wrapper text-center">
                            <div class="title1-inner">
                                ...
                                <p itemprop="description">Things that get tricky are things like burgers and fries, or
                                    things that are deep-fried. We do have a couple of burger restaurants that are capable
                                    of doing a good job transporting but it's Fries are almost impossible.</p>
                            </div>
                        </div>
                            ...
                            <ul class="restaurants-wrapper style2">
                                <li class="wow bounceIn" data-wow-delay="0.2s">
                                    <div class="top-restaurant"><a class="brd-rd50" href="#" title="Restaurant 1"
                                            itemprop="url"><img src="frontend/assets/images/resource/top-restaurant1.png"
                                ...
                                <li class="wow bounceIn" data-wow-delay="0.4s">
                                    <div class="top-restaurant"><a class="brd-rd50" href="#" title="Restaurant 2"
                                            itemprop="url"><img src="frontend/assets/images/resource/top-restaurant2.png"
                                ...
                                <li class="wow bounceIn" data-wow-delay="0.6s">
                                    <div class="top-restaurant"><a class="brd-rd50" href="#" title="Restaurant 3"
                                            itemprop="url"><img src="frontend/assets/images/resource/top-restaurant3.png"
                                ...
                                <li class="wow bounceIn" data-wow-delay="0.8s">
                                    <div class="top-restaurant"><a class="brd-rd50" href="#" title="Restaurant 4"
                                            itemprop="url"><img src="frontend/assets/images/resource/top-restaurant4.png"
                                ...
                                <li class="wow bounceIn" data-wow-delay="1s">
                                    <div class="top-restaurant"><a class="brd-rd50" href="#" title="Restaurant 5"
                                            itemprop="url"><img src="frontend/assets/images/resource/top-restaurant5.png"
                                                alt="top-restaurant5.png" itemprop="image"></a></div>
                                </li>
                                <li class="wow bounceIn" data-wow-delay="1.2s">
                                    <div class="top-restaurant"><a class="brd-rd50" href="#" title="Restaurant 5"
                                            itemprop="url"><img src="frontend/assets/images/resource/top-restaurant6.png"
                        ...
                        <div class="row remove-ext5">
                            ...
                            <div class="col-md-4 col-sm-6 col-lg-4">
                                <div class="popular-dish-box wow fadeIn" data-wow-delay="0.6s">
                                    <div class="popular-dish-thumb">
                                        <a href="food-detail.html" title="" itemprop="url"><img
                                                src="frontend/assets/images/resource/popular-dish-img3.jpg"
                                                alt="popular-dish-img3.jpg" itemprop="image"></a>
    ...
    <section>
        <div class="block grayish low-opacity">
            ...
            <div class="top-mockup"><img src="frontend/assets/images/resource/mockup2.png" alt=""></div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="dishes-caro">
                            <div class="dish-item">
                                <figure><img src="frontend/assets/images/resource/dish-caro1.jpg" alt=""></figure>
                                <div class="item-meta">
                                    <img src="frontend/assets/images/resource/restaurant-logo2.png" alt="">
                                    <div>
                            ...
                            <div class="dish-item">
                                <figure><img src="frontend/assets/images/resource/dish-caro1.jpg" alt=""></figure>
                                <div class="item-meta">
                                    <img src="frontend/assets/images/resource/restaurant-logo3.png" alt="">
                                    <div>
                            ...
                            <div class="dish-item">
                                <figure><img src="frontend/assets/images/resource/dish-caro1.jpg" alt=""></figure>
                                <div class="item-meta">
                                    <img src="frontend/assets/images/resource/restaurant-logo4.png" alt="">
                                    <div>
                        ...
                        <div class="popular-of-month">
                            <div class="pop-dish wow fadeIn" data-wow-delay="0.1s">
                                <div class="poplr-dish">
                                    <img src="frontend/assets/images/resource/round-pic1.jpg" alt="">
                                    <div class="dish-meta">
                                        <span>$10.00–$30.00</span>
                                ...
                                <div class="item-meta">
                                    <img alt="" src="frontend/assets/images/resource/restaurant-logo2.png">
                                    <div>
                                        <span>Jagnetina Na Raznju</span>
                                        <p>68 5th Avenue New York </p>
                                    </div>
                            ...
                            <div class="pop-dish wow fadeIn" data-wow-delay="0.2s">
                                <div class="poplr-dish">
                                    <img src="frontend/assets/images/resource/round-pic2.jpg" alt="">
                                    <div class="dish-meta">
                                        <span>$10.00–$30.00</span>
                                ...
                                <div class="item-meta">
                                    <img alt="" src="frontend/assets/images/resource/restaurant-logo3.png">
                                    <div>
                                        <span>Central Caffe Pizzeria</span>
                                        <p>68 5th Avenue New York </p>
                                    </div>
                            ...
                            <div class="pop-dish wow fadeIn" data-wow-delay="0.3s">
                                <div class="poplr-dish">
                                    <img src="frontend/assets/images/resource/round-pic3.jpg" alt="">
                                    <div class="dish-meta">
                                        <span>$10.00–$30.00</span>
                                ...
                                <div class="item-meta">
                                    <img alt="" src="frontend/assets/images/resource/restaurant-logo4.png">
                                    <div>
                                        <span>Dream Food By Opaq</span>
                                        <p>68 5th Avenue New York </p>
                                    </div>
                            ...
                            <div class="pop-dish">
                                <div class="poplr-dish wow fadeIn" data-wow-delay="0.4s">
                                    <img src="frontend/assets/images/resource/round-pic4.jpg" alt="">
                                    <div class="dish-meta">
                                        <span>$10.00–$30.00</span>
                                ...
                                <div class="item-meta">
                                    <img alt="" src="frontend/assets/images/resource/restaurant-logo5.png">
                                    <div>
            ...
            <div class="bottom-mockup"><img src="frontend/assets/images/resource/mockup1.png" alt=""></div>
        </div>
    </section>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-lg-4">
                                    <div class="step-box wow fadeIn" data-wow-delay="0.2s">
                                        <i><img src="frontend/assets/images/resource/setp-img1.png" alt="setp-img1.png"
                                ...
                                <div class="col-md-4 col-sm-4 col-lg-4">
                                    <div class="step-box wow fadeIn" data-wow-delay="0.4s">
                                        <i><img src="frontend/assets/images/resource/setp-img2.png" alt="setp-img2.png"
                                ...
                                <div class="col-md-4 col-sm-4 col-lg-4">
                                    <div class="step-box wow fadeIn" data-wow-delay="0.6s">
                                        <i><img src="frontend/assets/images/resource/setp-img3.png" alt="setp-img3.png"
                                    ...
                                    <div class="featured-restaurants-list">
                                        <div class="featured-restaurant-box wow fadeIn" data-wow-delay="0.1s">
                                            <div class="featured-restaurant-thumb">
                                                <a href="food-detail.html" title="" itemprop="url"><img
                                                        class="brd-rd2"
                                                        src="frontend/assets/images/resource/featured-restaurant-img1.jpg"
                                                        alt="featured-restaurant-img1.jpg" itemprop="image"></a>
                                            </div>
                                            <div class="featured-restaurant-info">
                                                <span class="red-clr">5th Avenue New York 68</span>
                                                <h4 itemprop="headline"><a href="food-detail.html" title=""
                                                        itemprop="url">Tuna Roast Source</a></h4>
                                                <span class="price">$85.00</span>
                                                ...
                                                <span class="post-rate yellow-bg brd-rd2"><i class="fa fa-star-o"></i>
                                                    4.25</span>
                                            </div>
                                        </div>
                                        <div class="featured-restaurant-box wow fadeIn" data-wow-delay="0.2s">
                                            <div class="featured-restaurant-thumb">
                                                <a href="food-detail.html" title="" itemprop="url"><img
                                                        class="brd-rd2"
                                                        src="frontend/assets/images/resource/featured-restaurant-img2.jpg"
                                                        alt="featured-restaurant-img2.jpg" itemprop="image"></a>
                                            </div>
                                            <div class="featured-restaurant-info">
                                                <span class="red-clr">5th Avenue New York 68</span>
                                                <h4 itemprop="headline"><a href="food-detail.html" title=""
                                                        itemprop="url">Crab With Curry Sources</a></h4>
                                                <span class="price">$70.00</span>
                                        ...
                                        <div class="featured-restaurant-box wow fadeIn" data-wow-delay="0.3s">
                                            <div class="featured-restaurant-thumb">
                                                <a href="food-detail.html" title="" itemprop="url"><img
                                                        class="brd-rd2"
                                                        src="frontend/assets/images/resource/featured-restaurant-img3.jpg"
                                                        alt="featured-restaurant-img3.jpg" itemprop="image"></a>
                                            </div>
                                            <div class="featured-restaurant-info">
                                                <span class="red-clr">5th Avenue New York 68</span>
                                                <h4 itemprop="headline"><a href="food-detail.html" title=""
                                                        itemprop="url">Imported Salmon Steak</a></h4>
                                    ...
                                    <div class="featured-restaurant-gallery">
                                        <div class="featured-restaurant-carousel">
                                            <div class="featured-restaurant-thumb"><img class="brd-rd2"
                                                    src="frontend/assets/images/resource/featured-restaurant-gallery1.jpg"
                                                    alt="featured-restaurant-gallery1.jpg" itemprop="image"></div>
                                            <div class="featured-restaurant-thumb"><img class="brd-rd2"
                                                    src="frontend/assets/images/resource/featured-restaurant-gallery2.jpg"
                                                    alt="featured-restaurant-gallery2.jpg" itemprop="image"></div>
                                        </div>
                                        <div class="featured-restaurant-box">
                                            <div class="featured-restaurant-thumb">
                                                <a class="red-bg brd-rd2" data-fancybox href="https://vimeo.com/49674259"
                                                    title="Click To Play" itemprop="url"><i class="fa fa-play"></i></a>
                                                <span class="video-time">15mint</span>
                                            </div>
                                            <div class="featured-restaurant-info">
                                                <span class="red-clr">5th Avenue New York 68</span>
                                                <h4 itemprop="headline"><a href="food-detail.html" title=""
                                                        itemprop="url">Maenaam Thai Restaurant</a></h4>
                                                <span class="price">$85.00</span>
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="filters-wrapper">
                            ...
                            <ul class="filter-buttons center ext-btm20">
                                ...
                                <li><a class="brd-rd30" data-filter=".filter-item2" href="#"
                                        itemprop="url">Burgers</a></li>
                                <li><a class="brd-rd30" data-filter=".filter-item3" href="#"
                                        itemprop="url">Pasta</a></li>
                            </ul><!-- Filter Buttons -->
                                    ...
                                    <div class="masonry">
                                            ...
                                            <div class="featured-restaurant-box style2 brd-rd12 wow fadeIn"
                                                ...
                                                <div class="featured-restaurant-thumb">
                                                    <a href="restaurant-detail.html" title="" itemprop="url"><img
                                                            src="frontend/assets/images/resource/most-popular-img1-1.png"
                                                ...
                                                <div class="featured-restaurant-info">
                                                    ...
                                                    <span class="food-types">Type of food: <a href="#"
                                                            ...
                                                            href="#" title="" itemprop="url">BB.Q</a>, <a
                                                            href="#" title="" itemprop="url">Beef
                                                            Roast</a></span>
                                                    <ul class="post-meta">
                                                        <li><i class="fa fa-check-circle-o"></i> Min order $50</li>
                                                        <li><i class="flaticon-transport"></i> 30min</li>
                                                        <li><i class="flaticon-money"></i> Accepts cash & online payments
                                                        </li>
                                                    </ul>
                                                    <span class="post-rate yellow-bg brd-rd2"><i class="fa fa-star-o"></i>
                                                        4.25</span>
                                                    <span class="post-likes style2 red-clr"><i class="fa fa-heart-o"></i>
                                                        12</span>
                                                    <a class="brd-rd5" href="restaurant-detail.html"
                                                        title="Order Online">Order Now</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-lg-6 filter-item filter-item2">
                                            <div class="featured-restaurant-box style2 brd-rd12 wow fadeIn"
                                                ...
                                                <div class="featured-restaurant-thumb">
                                                    <a href="restaurant-detail.html" title="" itemprop="url"><img
                                                            src="frontend/assets/images/resource/most-popular-img1-2.png"
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6 filter-item filter-item3">
                                            <div class="featured-restaurant-box style2 brd-rd12 wow fadeIn"
                                                ...
                                                <div class="featured-restaurant-thumb">
                                                    <a href="restaurant-detail.html" title="" itemprop="url"><img
                                                            src="frontend/assets/images/resource/most-popular-img1-3.png"
                                        ...
                                        <div
                                            ...
                                            <div class="featured-restaurant-box style2 brd-rd12 wow fadeIn"
                                                ...
                                                <div class="featured-restaurant-thumb">
                                                    <a href="restaurant-detail.html" title="" itemprop="url"><img
                                                            src="frontend/assets/images/resource/most-popular-img1-4.png"
                                                            alt="most-popular-img1-4.png" itemprop="image"></a>
                                                </div>
                                                <div class="featured-restaurant-info">
                                                    <span class="red-clr">5th Avenue New York 68</span>
                                                    <h4 itemprop="headline"><a href="restaurant-detail.html"
                                                            title="" itemprop="url">Restaurant</a></h4>
                                                    <span class="food-types">Type of food: <a href="#"
                                                            title="" itemprop="url">Apple Juice</a>, <a
                                                            href="#" title="" itemprop="url">BB.Q</a>, <a
                                                            href="#" title="" itemprop="url">Beef
