                                                ...
                                                <div class="restaurant-detail-info">
                                                    <div class="restaurant-detail-thumb">
                                                        <ul class="restaurant-detail-img-carousel">
                                                            <li><img class="brd-rd3" src="{{ asset('images/restaurants/slider-details/restaurant-detail-big-img1-1.jpg') }}" alt="restaurant-detail-big-img1-1.jpg" itemprop="image"></li>
                                                            <li><img class="brd-rd3" src="{{ asset('images/restaurants/slider-details/restaurant-detail-big-img1-2.jpg') }}" alt="restaurant-detail-big-img1-2.jpg" itemprop="image"></li>
                                                            <li><img class="brd-rd3" src="{{ asset('images/restaurants/slider-details/restaurant-detail-big-img1-3.jpg') }}" alt="restaurant-detail-big-img1-3.jpg" itemprop="image"></li>
                                                        </ul>
                                                        <ul class="restaurant-detail-thumb-carousel">
                                                            <li><img class="brd-rd3" src="{{ asset('images/restaurants/slider-details/restaurant-detail-small-img1-1.jpg') }}" alt="restaurant-detail-small-img1-1.jpg" itemprop="image"></li>
                                                            <li><img class="brd-rd3" src="{{ asset('images/restaurants/slider-details/restaurant-detail-big-img1-2.jpg') }}" alt="restaurant-detail-small-img1-2.jpg" itemprop="image"></li>
                                                            <li><img class="brd-rd3" src="{{ asset('images/restaurants/slider-details/restaurant-detail-big-img1-3.jpg') }}" alt="restaurant-detail-small-img1-3.jpg" itemprop="image"></li>
                                                        </ul>
                                                    </div>
                                                        ...
                                                        <div class="tab-content">
                                                                        ...
                                                                        <li class="wow fadeInUp" data-wow-delay="0.1s">
                                                                            <div class="featured-restaurant-box">
                                                                                <div class="featured-restaurant-thumb">
                                                                                    <a href="#" title="" itemprop="url"><img src="{{ asset('images/restaurants/slider-details/dish-img1-1.jpg') }}" alt="dish-img1-1.jpg" itemprop="image"></a>
                                                                                </div>
                                                                ...
                                                                {{-- <div class="dishes-list-wrapper">
                                                                    ...
                                                                    <ul class="dishes-list">
                                                                        <li class="wow fadeInUp" data-wow-delay="0.2s">
                                                                            <div class="featured-restaurant-box">
                                                                                <div class="featured-restaurant-thumb">
                                                                                    <a href="#" title="" itemprop="url"><img src="assets/images/restaurants/slider-details/dish-img2-1.jpg" alt="dish-img2-1.jpg" itemprop="image"></a>
                                                                                </div>
                                                                                <div class="featured-restaurant-info">
                                                                        ...
                                                                        <li class="wow fadeInUp" data-wow-delay="0.3s">
                                                                            <div class="featured-restaurant-box">
                                                                                <div class="featured-restaurant-thumb">
                                                                                    <a href="#" title="" itemprop="url"><img src="assets/images/restaurants/slider-details/dish-img2-2.jpg" alt="dish-img2-2.jpg" itemprop="image"></a>
                                                                                </div>
                                                                                <div class="featured-restaurant-info">
                                                                        ...
                                                                        <li class="wow fadeInUp" data-wow-delay="0.4s">
                                                                            <div class="featured-restaurant-box">
                                                                                <div class="featured-restaurant-thumb">
                                                                                    <a href="#" title="" itemprop="url"><img src="assets/images/restaurants/slider-details/dish-img2-3.jpg" alt="dish-img2-3.jpg" itemprop="image"></a>
                                                                                </div>
                                                                                <div class="featured-restaurant-info">
                                                                        ...
                                                                        <li class="wow fadeInUp" data-wow-delay="0.5s">
                                                                            <div class="featured-restaurant-box">
                                                                                <div class="featured-restaurant-thumb">
                                                                                    <a href="#" title="" itemprop="url"><img src="assets/images/restaurants/slider-details/dish-img2-4.jpg" alt="dish-img2-4.jpg" itemprop="image"></a>
                                                                                </div>
                                                                                <div class="featured-restaurant-info">
                                                            ...
                                                            <div class="tab-pane fade" id="tab1-2">
                                                                <div class="restaurant-gallery">
                                                                    <h4 class="title3" itemprop="headline"><span class="sudo-bottom sudo-bg-red">Nik B</span>aker's Gallery XXX</h4>
                                                                    <div class="remove-ext">
                                                                        <div class="row">
                                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                                <div class="restaurant-gallery-img"
                                                                                ><a href="{{ asset('images/restaurants/slider-details/restaurant-gallery-img1.jpg') }}" data-fancybox="gallery" title="" itemprop="url"><img src="{{ asset('images/restaurants/slider-details/restaurant-gallery-img1.jpg') }}" alt="restaurant-gallery-img1.jpg" itemprop="image"></a></div>
                                                                            </div>
                                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                                <div class="restaurant-gallery-img"><a href="{{ asset('images/restaurants/slider-details/restaurant-gallery-img2.jpg') }}" data-fancybox="gallery" title="" itemprop="url"><img src="{{ asset('images/restaurants/slider-details/restaurant-gallery-img2.jpg') }}" alt="restaurant-gallery-img2.jpg" itemprop="image"></a></div>
                                                                            </div>
                                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                                                <div class="restaurant-gallery-img"><a href="{{ asset('images/restaurants/slider-details/restaurant-gallery-img1.jpg') }}" data-fancybox="gallery" title="" itemprop="url"><img src="{{ asset('images/restaurants/slider-details/restaurant-gallery-img1.jpg') }}" alt="restaurant-gallery-img1.jpg" itemprop="image"></a></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
