                                                ...
                                                <div class="restaurant-detail-info">
                                                    <div class="restaurant-detail-thumb">
                                                        ...
                                                        <ul class="restaurant-detail-thumb-carousel">
                                                            <li><img src="{{ asset("images/restaurants/{$restaurant->id}/s1.jpg") }}" alt="restaurant-detail-small-img1-1.jpg" itemprop="image"></li>
                                                            <li><img src="{{ asset("images/restaurants/{$restaurant->id}/s2.jpg") }}" alt="restaurant-detail-small-img1-2.jpg" itemprop="image"></li>
                                                            <li><img src="{{ asset("images/restaurants/{$restaurant->id}/s3.jpg") }}" alt="restaurant-detail-small-img1-3.jpg" itemprop="image"></li>
                                                            <li><img src="{{ asset("images/restaurants/{$restaurant->id}/s4.jpg") }}" alt="restaurant-detail-small-img1-4.jpg" itemprop="image"></li>
                                                        </ul>
                                                    </div>
                                                    <div class="restaurant-detail-title">
                                                        ...
                                                        <div class="rating-wrapper">
                                                            <a class="gradient-brd brd-rd2">
                                                                <i class="fa fa-star"></i> Rate <i>{{ $restaurant->avg_rating }}</i>
                                                            </a> 
                                                        </div>
                                                    </div>
                                                    <div class="restaurant-detail-tabs">
                                                        <ul class="nav nav-tabs"> 
                                                            <li class="active"><a href="#tab1-4" data-toggle="tab"><i class="fa fa-book"></i> Book A Table</a></li>
                                                        ...
                                                        <div class="tab-content"> 
                                                            <div class="tab-pane fade in active" id="tab1-4">
                                                                <div class="book-table">
                                                                    ...
                                                                    <form action="{{ route('website.bookings.store', $restaurant->id) }}" method="POST">
                                                                        @csrf
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                                <div class="input-field brd-rd2">
                                                                                    ...
                                                                                    <input class="datepicker" type="text" name="booking_date" placeholder="SELECT DATE" required>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                                <div class="input-field brd-rd2">
                                                                                    ...
                                                                                    <input class="timepicker" type="text" name="booking_time" placeholder="SELECT TIME" required>
                                                                                </div>
                                                                            </div>
                                            ...
                                            <div class="remove-ext">
                                                <div class="row">
                                                    @foreach($foods as $food)
                                                        @include('website.components.food-card', ['food' => $food,'restaurant' => $restaurant])
                                                    @endforeach
